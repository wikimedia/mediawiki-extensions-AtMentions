...
class ParserTest extends TestCase {
	...
	public function testParse() {
		...
		$this->assertSame( '[[User:B|UserB]]', $mentions[1]['text'] );
		$this->assertSame( 'B', $mentions[1]['user']->getName() );
		$this->assertSame( 'UserB', $mentions[1]['label'] );

		$this->assertSame( '[[User:C]]', $mentions[2]['text'] );
		$this->assertSame( 'C', $mentions[2]['user']->getName() );
		$this->assertSame( 'C real', $mentions[2]['label'] );

		$this->assertSame( '[[User:C|UserC]]', $mentions[3]['text'] );
		$this->assertSame( 'C', $mentions[3]['user']->getName() );
		$this->assertSame( 'UserC', $mentions[3]['label'] );
	}
	...
	public function testGetMentionedUsers() {
		...
		$this->assertSame( 'B', $users[1]->getName() );
		$this->assertSame( 'C', $users[2]->getName() );
	}
